...
- Name: Server Management >> should add a new server
- Location: /Users/amr/src/mcp-studio/tests/server-management.spec.js:26:3
...
Call log:
  - waiting for locator('#server-name')
    - locator resolved to <input type="text" required="" id="server-name"/>
    - fill("Test Server")
  - attempting fill action
    ...
    at /Users/amr/src/mcp-studio/tests/server-management.spec.js:34:16
```
