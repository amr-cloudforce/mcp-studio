...
- Name: Server Management >> should edit an existing server
- Location: /Users/amr/src/mcp-studio/tests/server-management.spec.js:47:3
...
Call log:
  - waiting for locator('tr:has-text("Test Server")').locator('button:has-text("Edit")')

    at /Users/amr/src/mcp-studio/tests/server-management.spec.js:50:56
```
